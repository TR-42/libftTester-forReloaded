...
MANDATORY02_EXISTING_SRC	= $(shell ls $(addprefix $(LIBFT_PATH)/ft_,$(addsuffix .c, $(MANDATORY02))) 2> /dev/null)
...
$(LIBFT00): $(MANDATORY00_EXISTING_OBJ)
	ar rc $(LIBFT_PATH)/$@ $^
	cp $(LIBFT_PATH)/$@ $(LIBFT_PATH)/libft.a

$(LIBFT01): $(MANDATORY01_EXISTING_OBJ) $(MANDATORY00_EXISTING_OBJ)
	ar rc $(LIBFT_PATH)/$@ $^
	cp $(LIBFT_PATH)/$@ $(LIBFT_PATH)/libft.a

$(LIBFT02): $(MANDATORY02_EXISTING_OBJ) $(MANDATORY00_EXISTING_OBJ) $(MANDATORY01_EXISTING_OBJ)
	ar rc $(LIBFT_PATH)/$@ $^
	cp $(LIBFT_PATH)/$@ $(LIBFT_PATH)/libft.a
